    ...
    <>
      ...
      <main className="min-h-screen bg-background">
        <div className="mx-auto max-w-4xl px-6 py-12">
          <h1 className="text-4xl font-bold mb-2">About Steganography</h1>
          <p className="text-foreground-muted mb-12">Understanding the art and science of hidden data</p>

          <div className="space-y-12">
            {/* What is Steganography */}
            <section className="bg-surface-secondary border border-border rounded-lg p-8">
              <h2 className="text-2xl font-bold mb-4 text-primary">What is Steganography?</h2>
            ...
            {/* Method Details */}
            <section>
              <h2 className="text-2xl font-bold mb-6">Embedding Methods</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-surface-secondary border border-border rounded-lg p-8">
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-bold mb-2">EXIF Metadata</h3>
                ...
                <div className="bg-surface-secondary border border-border rounded-lg p-8">
                  <div className="flex items-start gap-4 mb-4">
                    <div className="text-3xl">💾</div>
                    <div className="flex-1">
                      <h3 className="text-xl font-bold mb-2">LSB (Least Significant Bit) Encoding</h3>
                      <p className="text-foreground-muted text-sm">
                ...
                <div className="bg-surface-secondary border border-border rounded-lg p-8">
                  <div className="flex items-start gap-4 mb-4">
                    <div className="text-3xl">📄</div>
                    <div className="flex-1">
                      <h3 className="text-xl font-bold mb-2">PNG Text Chunks</h3>
                      <p className="text-foreground-muted text-sm">
            ...
            {/* Security Note */}
            <section className="bg-surface-secondary border border-border rounded-lg p-8">
              <h2 className="text-2xl font-bold mb-4 text-warning">Security Considerations</h2>
              <p className="text-foreground-muted mb-4">
